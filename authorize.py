...
class ScreenAuthorize(LcarsScreen):
    ...
    def setup(self, all_sprites):
        ...
        all_sprites.add(LcarsGifImage("assets/gadgets/stlogorotating.gif", (369, 130), 50), 
                        layer=0)        

        all_sprites.add(LcarsText(colours.RED, (-1, 330), "AUTHORIZATION REQUIRED", 2),
                        layer=0)

        all_sprites.add(LcarsText(colours.BLUE, (-1, 360), "ONLY AUTHORIZED PERSONNEL MAY ACCESS THIS TERMINAL", 1.5),
                        layer=1)

        all_sprites.add(LcarsText(colours.BLUE, (-1, 390), "BUILDING BETTER WORLDS", 1.5),
                        layer=1)
